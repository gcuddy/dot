...
-- Window resizing (Meta+Arrow)
map("n", "<M-Left>", "<C-w><", { desc = "Decrease width" })
map("n", "<M-Right>", "<C-w>>", { desc = "Increase width" })
map("n", "<M-Up>", "<C-w>+", { desc = "Increase height" })
map("n", "<M-Down>", "<C-w>-", { desc = "Decrease height" })
