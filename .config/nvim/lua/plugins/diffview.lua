return {
	{
		...
		keys = {
			{ "<leader>gvo", "<cmd>DiffviewOpen<cr>", desc = "Diffview open (working copy)" },
			{ "<leader>gvc", "<cmd>DiffviewClose<cr>", desc = "Diffview close" },
			{ "<leader>gvf", "<cmd>DiffviewFileHistory %<cr>", desc = "Diffview file history (current)" },
			...
			require("diffview").setup({
				...
				keymaps = {
					view = {
						...
						{ "n", "<leader>gvt", actions.toggle_files, { desc = "Toggle file panel" } },
